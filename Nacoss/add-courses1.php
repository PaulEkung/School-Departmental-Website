...
<div class="header p-3 bg-dark text-light text-center">Add ND1 Courses</div>
<br>
<form action="add-courses1.php" method="post" autocomplete="off" class="p-4 shadow">
...
<br>
<input type="text" class="form-control" Placeholder="Credit unit"  name="unit">
<br>
