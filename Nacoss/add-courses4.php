...
<div class="header p-3 bg-dark text-light text-center">Add HND2 Courses</div>
<br>
<form action="add-courses4.php" method="post" autocomplete="off" class="p-4 shadow">
