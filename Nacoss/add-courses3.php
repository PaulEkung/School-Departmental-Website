...
<div class="header p-3 bg-dark text-light text-center">Add HND1 Courses</div>
<br>
<form action="add-courses3.php" method="post" autocomplete="off" class="p-4 shadow">
