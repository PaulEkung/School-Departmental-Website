...
require "connection.php";
    ...
    {
        $id = $_GET["id"];
        $sql = $connection->query("SELECT * from `hnd1` where `id` = '$id';");
        if($sql)
        {
...
<br>
<form action="update-3.php" method="post" autocomplete="off" class="p-4 shadow">
...
$unit = $_POST["unit"];
$id = $_POST["id"];
$sql = $connection->query("UPDATE hnd1 set course_title='$title', course_code='$code', credit_load='$unit' where id = `hnd1`.id");
if($sql)
{
